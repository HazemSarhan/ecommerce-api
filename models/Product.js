...
const ProductSchema = new mongoose.Schema(
  {
    ...
    company: {
      type: String,
      required: [true, 'Please provide a valid product company'],
      enum: {
...
// sets up a virtual property to get reviews for [get single product]
...
// Middleware to delete associated reviews before deleting a product
ProductSchema.pre(
  'deleteOne',
